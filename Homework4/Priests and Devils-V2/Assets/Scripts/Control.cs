...
/*-----------------------------------Moveable------------------------------------------*/
	...
	public class bankController {
		...
		public bankController(string _to_or_from) {
			positions = new Vector3[] {new Vector3(6.5F,3.5f,0), new Vector3(7.7F,3.5f,0), new Vector3(8.9F,3.5f,0), 
				new Vector3(10.1F,3.5f,0), new Vector3(11.3F,3.5f,0), new Vector3(12.5F,3.5f,0)};
	...
	public class BoatController {
		...
		public BoatController() {
			...
			from_positions = new Vector3[] { new Vector3 (2F, 2.5F, 0), new Vector3 (4F, 2.5F, 0) };
			to_positions = new Vector3[] { new Vector3 (-4F, 2.5F, 0), new Vector3 (-2F, 2.5F, 0) };
